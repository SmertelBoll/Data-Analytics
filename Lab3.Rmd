...
model_4 <- lm(Total.Charges.log ~ Length.of.Stay + Lenght.of.Stay.Censor + APR.Severity.of.Illness.Code + is.Female + APR.Risk.of.Mortality +
...
stargazer(model_1, model_2, model_3, model_4, type = "latex",
          ...
          dep.var.labels = c("Середня оцінка"),
          dep.var.caption = "",
          se = list(model_1_hc1[, 2], model_2_hc1[, 2], model_3_hc1[, 2], model_4_hc1[, 2]),
          omit.stat = c("rsq", "f", "ser"),
          no.space = TRUE,
          font.size = "tiny", 
