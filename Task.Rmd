...
Довірчій інтервал для довжини перебування
```{r}
...
Довірчій інтервал для собівартості
```{r}
data <- df$Total.Costs
...
cat("Верхня межа:", upper_bound)
```
Довірчій інтервал для ваги при народженні
```{r}
...
Довірчий інтервал для довжини перебування (бутстреп)
```{r}
...
Довірчий інтервал для ціни (бутстреп)
```{r}
mean_func <- function(data, index) {
  mean(data[index])
}
...
Довірчий інтервал для собівартості (бутстреп)
```{r}
mean_func <- function(data, index) {
  mean(data[index])
}
...
Довірчий інтервал для ваги при народженні (бутстреп)
```{r}
mean_func <- function(data, index) {
  mean(data[index])
}
